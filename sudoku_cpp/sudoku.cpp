...
for (uint i = 0; i < 81; i++) {
std::string new_cmp_name = "LowerBound"+ctx->generate_position_array(aux_dimensions, 2, i);
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint aux_dimensions[2] = {9,9};
for (uint i = 0; i < 81; i++) {
std::string new_cmp_name = "UpperBound"+ctx->generate_position_array(aux_dimensions, 2, i);
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint csoffset = mySignalStart+6642;
uint aux_dimensions[2] = {9,9};
for (uint i = 0; i < 81; i++) {
std::string new_cmp_name = "equalBoard"+ctx->generate_position_array(aux_dimensions, 2, i);
mySubcomponents[aux_create+i] = aux_cmp_num;
...
{
uint aux_create = 243;
int aux_cmp_num = 2268+ctx_index+1;
uint csoffset = mySignalStart+11988;
uint aux_dimensions[2] = {9,9};
for (uint i = 0; i < 81; i++) {
std::string new_cmp_name = "zeroBoard"+ctx->generate_position_array(aux_dimensions, 2, i);
mySubcomponents[aux_create+i] = aux_cmp_num;
IsZero_4_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 3 ;
aux_cmp_num += 1;
...
{
uint aux_create = 324;
int aux_cmp_num = 1296+ctx_index+1;
...
{
uint aux_create = 972;
int aux_cmp_num = 1944+ctx_index+1;
uint csoffset = mySignalStart+11016;
uint aux_dimensions[1] = {324};
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 81)]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 0)]].signalStart + 0]); // line circom 25
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[5]); // line circom 36
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[1];
// load src
...
Fr_sub(&expaux[2],&circuitConstants[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 243)]].signalStart + 0]); // line circom 45
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((9 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 162)]].signalStart + 0],&expaux[2]); // line circom 45
...
Fr_lt(&expaux[0],&lvar[3],&lvar[2]); // line circom 61
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[0])) + 324)]].signalStart + 0],&circuitConstants[1]); // line circom 65
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 81
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[3];
// load src
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 82
while(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[4],&lvar[2]); // line circom 83
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 648)]].signalStart + 0],&circuitConstants[1]); // line circom 87
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 88
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[4];
// load src
Fr_add(&expaux[0],&lvar[4],&circuitConstants[2]); // line circom 83
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[4],&lvar[2]); // line circom 83
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[2]); // line circom 82
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 82
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 81
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 81
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 102
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[4];
// load src
...
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[5]); // line circom 103
while(Fr_isTrue(&expaux[0])){
{
...
Fr_add(&expaux[2],&lvar[3],&circuitConstants[6]); // line circom 104
Fr_lt(&expaux[0],&lvar[5],&expaux[2]); // line circom 104
while(Fr_isTrue(&expaux[0])){
{
...
Fr_add(&expaux[2],&lvar[4],&circuitConstants[6]); // line circom 105
Fr_lt(&expaux[0],&lvar[6],&expaux[2]); // line circom 105
while(Fr_isTrue(&expaux[0])){
{
...
Fr_leq(&expaux[0],&lvar[7],&lvar[5]); // line circom 106
while(Fr_isTrue(&expaux[0])){
{
...
Fr_lt(&expaux[0],&lvar[8],&lvar[6]); // line circom 107
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[2])) + 972)]].signalStart + 0],&circuitConstants[1]); // line circom 111
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[2]); // line circom 112
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[8];
// load src
Fr_add(&expaux[0],&lvar[8],&circuitConstants[2]); // line circom 107
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[8],&lvar[6]); // line circom 107
...
PFrElement aux_dest = &lvar[7];
// load src
Fr_add(&expaux[0],&lvar[7],&circuitConstants[2]); // line circom 106
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_leq(&expaux[0],&lvar[7],&lvar[5]); // line circom 106
...
PFrElement aux_dest = &lvar[6];
// load src
Fr_add(&expaux[0],&lvar[6],&circuitConstants[2]); // line circom 105
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_add(&expaux[2],&lvar[4],&circuitConstants[6]); // line circom 105
...
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[5],&circuitConstants[2]); // line circom 104
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_add(&expaux[2],&lvar[3],&circuitConstants[6]); // line circom 104
...
PFrElement aux_dest = &lvar[4];
// load src
Fr_add(&expaux[0],&lvar[4],&circuitConstants[6]); // line circom 103
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[5]); // line circom 103
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[6]); // line circom 102
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 102
